...
<article class="content forms-page">
  ...
  <div class="title-block">
    <span class=""><i class="fa fa-archive bigicon icon_nav" >ADMINISTRACIÓN DE MANTENIMIENTOS </i></span>
       <p class="title-description"> Mantenimientos preventivos realizados Maquinaria</p>
   </div>
                    ...
                    <div class="card table-responsive">
                      <div class="card-block table-responsive">
                        ...
                        <section class="example">
                          {!!link_to_action("MantenimientoPreMaqController@finalizadas", $title = "Finalizadas", $parameters = 1, $attributes = ["class"=>"btn btn-primary btn-sm"])!!}
                          {!!link_to_action("MantenimientoPreMaqController@pendientes", $title = "Pendientes", $parameters = 1, $attributes = ["class"=>"btn btn-sm btn-info"])!!}
