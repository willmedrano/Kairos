  ...
  <div class="col-md-12">
    <div class="box-body">
      ...
      $fecha2=explode('-', $fch2);?>
              ...
              <div style="position: absolute;left: 380px; top: 180px; z-index: 1;" ><h3>FORMATO PARA CAMIONES {{"PLACA: ".$v->nPlaca." ".$v->nomModelo}}</h3>                  
            </div>
            <div  style="position: absolute;left: 450px; top: 200px; z-index: 1;">
