    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="gridModalLabel">Modificar Foto de la Maquinaria</h4>
            </div>
            <div class="modal-body">
                <div class="container-fluid bd-example-row">
                  {!! Form::model($maquinaria,['route'=>['maquinaria.update',$m->id],'method'=>'PUT','enctype'=>'multipart/form-data']) !!}
                        <fieldset>
