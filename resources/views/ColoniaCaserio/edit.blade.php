    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="gridModalLabel">Modificar Colonia/Caserio</h4>
            </div>
            <div class="modal-body">
                <div class="container-fluid bd-example-row">
                    {!!Form::model($cc,['method'=>'PATCH','enctype'=>'multipart/form-data','route'=>['coloniaCaserio.update',$c->id]])!!}
                        <fieldset>
