...
<head>
	<meta charset="UTF-8">
	<title> Mttn Preventivo General </title>
	<style>
body {
  ...
  <div class="col-md-12">
    <div class="box-body">
      ...
      $fecha2=explode('-', $fch2);?>
              ...
              <div style="position: absolute;left: 270px; top: 180px; z-index: 1;"><h3>Mantenimientos Preventivos Realizados a Vehiculos y Maquinaria </h3>                  
            </div>
            <div  style="position: absolute;left: 395px; top: 205px; z-index: 1;">
