...
<article class="content forms-page">
  ...
  <div class="title-block">
    <span class=""><i class="fa fa-archive bigicon icon_nav" > Tipo </i></span>
       <p class="title-description"> Registro de Tipo de Vehiculo/Maquinaria </p>
   </div>
                      ...
                      <div class="card-block table-responsive">
                        ...
                        <div id="collapseOne" class="body">
                          <div class="form-group">
                            ...
                            <div class="col-lg-3">
                              {!!Form::text('TipoVM',null,['id'=>'TipoVM','class'=>'form-control', 'placeholder'=>'Ingrese el tipo ...','required'])!!}
                            </div>
