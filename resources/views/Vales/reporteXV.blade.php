    ...
    <div class="modal-content">
      ...
      <div class="modal-header alert-warning" bgcolor="blue">
        ...
        <span class="col-md-2  text-center" style="color: white;" >
          ...
          <h4 class="modal-title" id="gridModalLabel2" >Reporte de Combustible</h4>
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid bd-example-row">
          ...
          {!! Form::open(['url'=>['filtroValeV'],'method'=>'POST','target'=>'_blank']) !!}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid bd-example-row">
          ...
          {!! Form::open(['url'=>['reporteEntradaV2'],'method'=>'POST','target'=>'_blank']) !!}
                              <input type="hidden" name="idV" value="{{ $v->id }}">
                              {!!Form::label('lbFecha','Fecha Inicial')!!}                          
                              <input id="fechaInicial" name="fechaInicial" type="date" required="true"class="form-control" value="<?php echo dameFecha(date("Y-m-d"),0);?>" max="<?php echo dameFecha(date("Y-m-d"),0);?>" >
                            </div>        
...
<div id="gridSystemModal4{{$v->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header alert-warning" bgcolor="blue">
        ...
        <span class="col-md-2  text-center" style="color: white;" >
          ...
          <h4 class="modal-title" id="gridModalLabel4" >Reporte para Camiones
          </h4>
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid bd-example-row">
          ...
          {!! Form::open(['url'=>['reporteEntradaC2'],'method'=>'POST','target'=>'_blank']) !!}
                              <input type="hidden" name="idV" value="{{ $v->id }}">
                              {!!Form::label('lbFecha','Fecha Inicial')!!}                          
                              <input id="fechaInicial" name="fechaInicial" type="date" required="true"class="form-control" value="<?php echo dameFecha(date("Y-m-d"),0);?>" max="<?php echo dameFecha(date("Y-m-d"),0);?>" >
                            </div>        
...
<div id="gridSystemModalExC{{$v->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header alert-warning" bgcolor="blue">
        ...
        <span class="col-md-2  text-center" style="color: white;" >
          ...
          <h4 class="modal-title" id="gridModalLabel4" >Excel para Camiones
          </h4>
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid bd-example-row">
          ...
          {!! Form::open(['url'=>['reporteEntradaCEx'],'method'=>'POST','target'=>'_blank']) !!}
                              <input type="hidden" name="idV" value="{{ $v->id }}">
                              {!!Form::label('lbFecha','Fecha Inicial')!!}                          
                              <input id="fechaInicial" name="fechaInicial" type="date" required="true"class="form-control" value="<?php echo dameFecha(date("Y-m-d"),0);?>" max="<?php echo dameFecha(date("Y-m-d"),0);?>" >
                            </div>        
