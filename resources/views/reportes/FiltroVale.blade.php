...
<article class="content forms-page">
  ...
  <div class="title-block">
    <span class=""><i class="fa fa-archive bigicon icon_nav" > Reporte Vales de Combustible asignados a Vehiculos  </i></span>
       <p class="title-description"> Vehiculo </p>
   </div>
                ...
                <div class="row table-responsive"> <!--Begin Datatables-->
                    <div class="card table-responsive">
                      <div class="card-block table-responsive">
                        ...
                        {!! Form::open(['url'=>['reporteVale'],'method'=>'POST','target'=>'_blank']) !!}
