...
<article class="content forms-page">
  ...
  <div class="title-block">
    <span class=""><i class="fa fa-archive bigicon icon_nav" >ADMINISTRACIÓN DE MANTENIMIENTOS </i></span>
       <p class="title-description"> Mantenimientos correctivos realizados </p>
   </div>
                    ...
                    <div class="card table-responsive">
                      <div class="card-block table-responsive">
                        ...
                        <section class="example">
                          {!!link_to_action("MantenimientoCorVehController@finalizadas", $title = "Finalizadas", $parameters = 1, $attributes = ["class"=>"btn btn-primary btn-sm"])!!}
                          {!!link_to_action("MantenimientoCorVehController@pendientes", $title = "Pendientes", $parameters = 1, $attributes = ["class"=>"btn btn-sm btn-info"])!!}
                          <table class="table table-bordered table-hover" style="width:100%" >
                            <thead>
                               <tr>
                                 ...
                                 <th ><div align="center">VEHICULO</div></th>
                             ...
                             <tbody id="hola" class="buscar">
                               <?php $cont=1; ?>
                               @foreach ($matt as $m)
                                 @include('mantenimientoCorrectivo.mcRealizadoDetalle')
                                 <tr>
