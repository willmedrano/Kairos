  ...
  <div class="col-md-12">
    <div class="box-body">
      <div class="box-header with-border">
        ...
        <div style="position: absolute;left: 230px; top: 160px; z-index: 1;"><h3>Listado General de Vehiculos, Maquinaria y Equipo de Terraceria Municipales</h3></div>
        <div style="position: absolute;left: 365px; top: 178px; z-index: 1;"><h3>Unidad de Transporte y Mantenimiento</h3></div>
      </div><!-- /.box-header -->
      <br>
      <br>
      <br>
