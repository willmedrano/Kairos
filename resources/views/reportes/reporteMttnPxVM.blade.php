...
<head>
	<meta charset="UTF-8">
	<title> Mttn Preventivo por V/M </title>
	<style>
body {
  ...
  <div class="col-md-12">
    <div class="box-body">
      ...
      $fecha2=explode('-', $fch2);?>
              ...
              <div style="position: absolute;left: 375px; top: 180px; z-index: 1;"><h3>Mantenimientos Preventivos Realizados  </h3>                  
            </div>
            <div  style="position: absolute;left: 425px; top: 205px; z-index: 1;">
