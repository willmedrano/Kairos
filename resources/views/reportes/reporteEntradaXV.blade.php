  ...
  <div class="col-md-12">
    <div class="box-body">
      ...
      $fecha2=explode('-', $fch2);?>
              ...
              <div style="position: absolute;left: 380px; top: 210px; z-index: 1;" ><h3>Control de Entradas y Salidas de vehiculo {{"Placa: ".$v->nPlaca." ".$v->nomModelo}}</h3>                  
            </div>
            <div  style="position: absolute;left: 480px; top: 230px; z-index: 1;">
