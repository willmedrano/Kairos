      ...
      <div class="modal-body" >
        <div class="container-fluid bd-example-row">
          <div class="pull-left image">
             ...
             <div class="col-xs-6">{!!Form::textarea('observacionFinalMtt',$m->fallasVeh,['class'=>'form-control', 'placeholder'=>'lista del trabajo realizado', 'rows'=>'4', 'cols'=>'5','required','readonly'])!!}</div>
